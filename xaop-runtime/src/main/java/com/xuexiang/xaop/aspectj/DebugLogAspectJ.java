...
public class DebugLogAspectJ {
    ...
    @Before("execution(* com.xuexiang.xaopdemo.MainActivity.on*(android.os.Bundle))")
    public void onActivityMethodBefore(JoinPoint joinPoint) throws Throwable {
        String key = joinPoint.getSignature().toString();
        Log.d("chenhong", "onActivityMethodBefore: " + key);
    }


    @After("execution(* com.xuexiang.xaopdemo.MainActivity.on*(android.os.Bundle))")
    public void onActivityMethodAfter(JoinPoint joinPoint) throws Throwable {
        String key = joinPoint.getSignature().toString();
        Log.d("chenhong", "onActivityMethodAfter: " + key);
    }
